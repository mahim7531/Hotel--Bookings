...
const RadioButton=({label,selected=false,onChange=()=>{ }})=>{
    return(
        ...
        <label  className='flex gap-3 items-center cursor-pointer mt-2 text-sm'>
            <input type="radio" namr="sortOption" checked={selected}  onChange={()=> onChange(label)} />
            <span className='font-light select-none'>{label}</span>
        </label>
    )
  ...
  return (
    ...
    lg:px-24 xl:px-32'>
        ...
        <div  >
         ...
         <div>
          ...
          {roomsDummyData.map((room)=>(
            ...
            <div key={room._id} className='flex felx-col md:flex-row items-start py-10 gap-6 border border-gray-300 last:pb-30 last:border-0'>
        ...
        <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16'>
            ...
            <div className={`${openFilters ? 'h-auto' : "h-0 lg:h-auto"} overflow-hidden transiiton-all duration-700`}>
