    ...
    {/*Room Rating */} 
      <div className='flex items-center gap-1 mt-2'>
        ...
        <div className='flex items-center gap-1 text-gray-500 mt-2'>
            <img src={assets.locationIcon} alt="location-icon" className='flex items-center gap-1
             text-gray-500 mt-2' />
             ...
             bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl  mx-auto  mt-16 max-w-6xl'>
              ...
              md:gap-10 text-gray-500'>
               ...
               <div className='flex flex-col'> 
                ...
                <input type="date" id='checkInDate' placeholder='Check-In' className='w-full rounded
                ...
                <input type="date" id='checkOutDate' placeholder='Check-Out' className='w-full rounded
                border border-gray-300 px-3 py-2 mt-1.5 outline-none' required/>
               </div>
              ...
              <div className='mt-25 space-y-4'>
                ...
                {roomCommonData.map((spec,index)=>(
                  <div key={index} className='flex items-start gap-2'>
                   <img src={spec.icon} alt={`${spec.title}-icon`} className='6.5' />
