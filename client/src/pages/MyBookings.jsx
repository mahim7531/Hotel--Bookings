...
const MyBookings= () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:p-24 xl:px-32'>
              ...
              <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                ...
                {/* ------Hotel Details----- */}
                 <div className='flex  flex-col md:flex-row'>
                  ...
                  <div className='felx flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                ...
                {/* ---Date & Timings----- */}
                 <div className='felx flex-row md:items-center md:gap-12 mt-3 gap-8'>
                  <div>
                    <p>Check-In:</p>
                 ...
                 <div className='flex flex-col items-start justify-center pt-3'> 
                  ...
                  {!booking.isPaid &&  (
                    <button className='px-4 py-1.5 text-xs border border-gray-400 rounded-full hover:bg-gray-50 transition-all
                    cursor-pointer'>
                      Pay Now
                    </button>
                  )}
