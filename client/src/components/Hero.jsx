...
const Hero = () => {
  return (
    ...
    bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen '>
       ...
       font-bold md:font-exxtrabold max-w-xl mr-4'>Discover Your Perfect  Gateway  Destination </h1>

       <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalleded luxury and comfort await at the world's most exculsive hotels and resorts.Start your 
        journeytoday.
       </p>
